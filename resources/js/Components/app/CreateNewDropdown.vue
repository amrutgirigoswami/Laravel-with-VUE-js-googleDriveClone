<template>
      ...
      >
        ...
        <div class="px-1 py-1">
            <MenuItem v-slot="{active}">
                 <a href="#" @click.prevent="showCreateFolderModal" class="text-gray-800 block px-4 py-2 text-sm">New Folder </a>          
            </MenuItem>
        </div>
          <div class="px-1 py-1">
            <FileUploadMenuItem/>
    ...
    <CreateFolderModal v-model="createRefFolderModal"/>
</template>
...
const createRefFolderModal = ref(false);
function showCreateFolderModal()
{
  createRefFolderModal.value = true;
}
